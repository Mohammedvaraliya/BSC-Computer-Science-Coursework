...
public class PracticalFive extends javax.swing.JFrame {

    
    public PracticalFive() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PracticalFive.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PracticalFive().setVisible(true);
            }
        });
    }
